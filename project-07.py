...
class visualialog(QDialog) :
    ...
    def setupUI(self) :
        # 윈도우 frame
        self.setWindowTitle("USING DATA")
    ...
    def pushButton1Clicked(self) :
        ...
        self.tableWidget.setRowCount(pizza.shape[0])             # table을 2 x 2로 만듦
        self.tableWidget.setColumnCount(pizza.shape[1])
        self.label1.setText("데이터는 총 " + str(pizza.shape[0]) + "개 입니다.")
    ...
    def pushButton2Clicked(self) :
        ...
        self.label1.setText("데이터는 총 " + str(busan_pizza.shape[0]) + "개 입니다.")
    ...
    def pushButton3Clicked(self) :
        ...
        self.tableWidget.setRowCount(for_sales.shape[0])             # table을 2 x 2로 만듦
        self.tableWidget.setColumnCount(for_sales.shape[1])
        self.label1.setText("데이터는 총 " + str(for_sales.shape[0]) + "개 입니다.")
    ...
    def pushButton4Clicked(self) :
        ...
        self.label1.setText("데이터는 총 " + str(commercial.shape[0]) + "개 입니다. \n\n데이터가 많은 관계로 \n상단 100개, 하단 100개, \n200개만 추려서 보여드립니다.")

        commercial = pd.concat([commercial.head(100), commercial.tail(100)], axis = 0)

        self.tableWidget.setRowCount(commercial.shape[0])             # table을 2 x 2로 만듦
    ...
    def pushButton5Clicked(self) :
        ...
        self.label1.setText("데이터는 총 " + str(singles.shape[0]) + "개 입니다.")

        self.tableWidget.setRowCount(singles.shape[0])             # table을 2 x 2로 만듦
    ...
    def pushButton6Clicked(self) :
        ...
        self.label1.setText("데이터는 총 " + str(cost.shape[0]) + "개 입니다.")

        self.tableWidget.setRowCount(cost.shape[0])             # table을 2 x 2로 만듦
...
class mywindows(QWidget) :
    ...
    def setupUI(self) :
        ...
        self.pushButton = QPushButton('using Data')  # Button, layout생성해서 사용할 때는 self 없이
